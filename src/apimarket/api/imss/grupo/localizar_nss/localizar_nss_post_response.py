...
if TYPE_CHECKING:
    from .localizar_nss_post_response_data import LocalizarNssPostResponse_data
...
class LocalizarNssPostResponse(AdditionalDataHolder, Parsable):
    ...
    # The data property
    data: Optional[List[LocalizarNssPostResponse_data]] = None
    ...
    def create_from_discriminator_value(parse_node: ParseNode) -> LocalizarNssPostResponse:
        ...
        Returns: LocalizarNssPostResponse
        """
        if not parse_node:
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "data": lambda n : setattr(self, 'data', n.get_collection_of_object_values(LocalizarNssPostResponse_data)),
