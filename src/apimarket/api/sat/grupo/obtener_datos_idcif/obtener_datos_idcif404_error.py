...
if TYPE_CHECKING:
    from .obtener_datos_idcif404_error_data import ObtenerDatosIdcif404Error_data

@dataclass
class ObtenerDatosIdcif404Error(APIError):
    ...
    # The data property
    data: Optional[ObtenerDatosIdcif404Error_data] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ObtenerDatosIdcif404Error:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: ObtenerDatosIdcif404Error
        """
        if not parse_node:
            raise TypeError("parse_node cannot be null.")
        return ObtenerDatosIdcif404Error()
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "data": lambda n : setattr(self, 'data', n.get_object_value(ObtenerDatosIdcif404Error_data)),
