...
if TYPE_CHECKING:
    from .validar_rfc404_error_data import ValidarRfc404Error_data

@dataclass
class ValidarRfc404Error(APIError):
    ...
    # The data property
    data: Optional[ValidarRfc404Error_data] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ValidarRfc404Error:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: ValidarRfc404Error
        """
        if not parse_node:
            raise TypeError("parse_node cannot be null.")
        return ValidarRfc404Error()
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "data": lambda n : setattr(self, 'data', n.get_object_value(ValidarRfc404Error_data)),
