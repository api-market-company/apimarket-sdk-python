...
if TYPE_CHECKING:
    from .obtener_cuenta_post_response_data import ObtenerCuentaPostResponse_data

@dataclass
class ObtenerCuentaPostResponse(AdditionalDataHolder, Parsable):
    ...
    # The data property
    data: Optional[ObtenerCuentaPostResponse_data] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ObtenerCuentaPostResponse:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: ObtenerCuentaPostResponse
        """
        if not parse_node:
            raise TypeError("parse_node cannot be null.")
        return ObtenerCuentaPostResponse()
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields: Dict[str, Callable[[Any], None]] = {
            ...
            "data": lambda n : setattr(self, 'data', n.get_object_value(ObtenerCuentaPostResponse_data)),
